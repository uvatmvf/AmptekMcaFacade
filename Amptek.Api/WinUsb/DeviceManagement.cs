...
namespace WinUsb
{
    ...
    public partial class DeviceManagement
	{
		...
		///  <param name="devicePathNames">Array of paths to devices</param>
		///
		///  <returns>
		///   True if a device is found, False if not.
		///  </returns>
		public static Boolean FindDeviceFromGuid(System.Guid myGuid, out List<String> devicePathNames)
		{
			Int32 bufferSize = 0;
			...
			try
			{
				...
				do
				{
					...
					else
					{
                        ...
                        IntPtr pDevicePathName = (Environment.Is64BitProcess) ?
                            pDevicePathName = new IntPtr(detailDataBuffer.ToInt64() + 4) :
